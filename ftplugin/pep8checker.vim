" File:         pep8checker.vim
" Author:       sly; originally by Joe Stelmach (joe@zenbe.com)
" Version:      0.001
" Last Modified: Jul 8, 2010

if !exists("pep8_command")
  let pep8_command = 'pep8'
endif

if !exists("pep8_highlight_color")
  let pep8_highlight_color = 'DarkMagenta'
endif

" set up auto commands
autocmd BufWritePost,FileWritePost *.py call PythonChecker()
...
function PythonChecker() 
  ...
  let cmd_output = system(g:pep8_command . ' ' . current_file)
...
function s:SetCursorLineColor() 
  ...
  if(!exists("g:pep8_highlight_color") || strlen(g:pep8_highlight_color) == 0) 
    return 
  endif
  ...
  execute "highlight CursorLine guibg=" . g:pep8_highlight_color
endfunction
